...
/// 单页特殊揭示方式
enum OnboardingReveal {
    case standard
    /// 第 7 页: 先显示上半屏 (下半纯黑), 0.5s 后显出下半屏, 再 0.5s 后出现文字
    case splitTopBottom
}
...
struct OnboardingStep {
    ...
    let revealStyle: OnboardingReveal

    init(index: Int, imageName: String, dialogues: [String],
         inputKind: OnboardingInputKind? = nil, ctaText: String? = nil,
         bubbleLayout: BubbleLayout = .bottom, revealStyle: OnboardingReveal = .standard) {
        self.index = index
...
let onboardingSteps: [OnboardingStep] = [
    ...
    OnboardingStep(
        ...
        dialogues: [
            "小女孩: 嗨！你终于来了！我们等了你好久。",
            "小女孩: 介绍一下！这位奶奶是未来的你，怎么样，和你想象中一样吗？我是童年的你，你还记得吗？嘿，听说你最近有很多心事，别着急，我们都和你在一起呢。",
            "你感到很疑惑。"
        ],
        inputKind: nil,
        ctaText: nil,
    ...
    // Step 15: 海边咖啡厅，开始旅程
    // Figma (2:23046): 旁白气泡贴顶, slide-to-confirm CTA 贴底, 二者分离.
    OnboardingStep(
        index: 14,
        imageName: "OnboardingStep14",
        dialogues: ["听着海浪声，你回想着发生的这一切。好想记录一些什么。"],
        inputKind: nil,
        ctaText: "开始你的记录旅程",
        bubbleLayout: .mixed(topCount: 1)
    ),
]
